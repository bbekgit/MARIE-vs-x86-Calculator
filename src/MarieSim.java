...
/* --                                                                                 -- */
  ...
  int  numInstructions = 0;            // Total number of instructions
  int  opcode = 18;                    // Total opcode
  int[] numInstruction = new int[opcode]; // Each Instruction count
  ...
  Hashtable codeReference                 // codeReference provides correspondence
            = new Hashtable(17, (float) 0.75);   // between monitor table and 
...
******************************************************************************************/
    ...
    try {
       instructionCode = Integer.parseInt(aString.substring(0,1), 17);
       numInstructions++;
...
******************************************************************************************/
    switch (instructionCode) {
       case  0: 
                numInstruction[instructionCode]++;
                jnS();
                break;
       case  1: 
                numInstruction[instructionCode]++;
       ...
       case  7: 
                numInstruction[instructionCode]++;
                halt();
                System.out.println("Total Instructions: " + numInstructions);
                for (int i = 0; i < 17; i++) {
                    System.out.println("Instruction opcode " + i + " : " + numInstruction[i]);
                }
                break;
       case  8: 
                numInstruction[instructionCode]++;
...
******************************************************************************************/
   ...
   void mult() { 
/******************************************************************************************
*   Multiply the value in the MBR to the AC.  (The MBR is loaded during instruction fetch.)   *
******************************************************************************************/
     regAC.setValue(regAC.getValue() * regMBR.getValue());
     regAC.postActionEvent();
   } // mult() 
 ...
 void div() { 
/******************************************************************************************
*   Divide the value in the MBR to the AC.  (The MBR is loaded during instruction fetch.)   *
******************************************************************************************/
     regAC.setValue(regAC.getValue() / regMBR.getValue());
     regAC.postActionEvent();
   } // div()  
