...
/* --                                                                                 -- */
  ...
  public Hashtable symbolTable                    // Initial capacity 18, load factor 0.75.
                           = new Hashtable(20, (float) 0.75);
  public final Hashtable instructionSet = new Hashtable(20);
...
void loadInstructionSet() {
 ...
 instructionSet.put("MULT",       new Instruction("MULT",       (byte) 15,  true));
 instructionSet.put("DIV",        new Instruction("DIV",        (byte) 16,  true));
